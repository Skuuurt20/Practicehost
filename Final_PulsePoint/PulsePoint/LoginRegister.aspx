...
<head runat="server">
    <title>Login / Register - PulsePoint</title>
    <style>
        /* Overall reset/body */
        html, body {
            margin: 0;
            padding: 0;
            height: 100%; /* So flex heights can work properly */
        ...
        /* CONTENT WRAPPER:
           - We'll make it flex:1 so it grows and pushes footer down. */
        #contentWrapper {
            flex: 1;
            display: flex;
        }
        ...
        #leftColumn {
            flex: 1; /* so it takes up all needed height */
            display: flex;
            align-items: center;
...
<body>
    <form id="form1" runat="server">
        <!-- ScriptManager for classic ASP.NET validators -->
        <asp:ScriptManager ID="ScriptManager1" runat="server" EnablePageMethods="true" />
        
        <!-- Page Wrapper to manage header + content + footer -->
        <div id="pageWrapper">

            <!-- NAVBAR -->
            <div id="navBar">
                <!-- Make the logo clickable => Onboarding.aspx -->
            ...
            <div id="contentWrapper">
                ...
                <div id="rightColumn">
                    <div class="container">
                        ...
                        <!-- REGISTER PANEL (visible by default) -->
                        <asp:Panel ID="registerPanel" runat="server" Style="display: block;">
                            <h2>Register</h2>
